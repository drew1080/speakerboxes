            ...
            uploader.bind('FileUploaded', function(up, file, response) {
                ...
                if(imgId=="img1"){
                    ...
                    jQuery.post(ajaxurl,
                    {
                      ...
                      fname=res;  
                      jQuery('#adpcon').append("<li id='li_"+file.id+"'><div id='"+file.id+"' style='float:left;padding:5px;' class='adp'><input type='hidden' id='in_"+file.id+"' name='wpmp_list[images][]' value='"+fname+"' /><nobr><b><img style='position:absolute;z-index:9999;cursor:pointer;' id='del_"+file.id+"' src='"+pluginurl+"/images/remove.png' rel='li_"+file.id+"' class='del_adp' align=left /><img src='"+pluginurl+"libs/timthumb.php?w=50&h=50&zc=1&src="+wpmp_image_url+fname+"'/></b></nobr><div style='clear:both'></div></div></li>");
                    });
                ...
                if(imgId=="img2"){
                    ...
                    jQuery.post(ajaxurl,
                    {
                      ...
                      var nm = fname;
                        ...
                        jQuery('#currentfiles').append("<li id='pro_"+file.id+"'><input type='hidden' id='in_"+file.id+"' name='wpmp_list[file][]' value='"+fname+"' /><nobr>[<a href='#' id='"+file.id+"' class='del_pro'>delete</a>]"+fname+"</nobr><div style='clear:both'></div></li>");
                        jQuery('#pro_'+file.id).fadeIn();
                        jQuery('#del_'+file.id).click(function(){
                            ...
                            jQuery('#pro_'+file.id).removeClass('dfile').addClass('cfile');
